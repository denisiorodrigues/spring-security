...
public class ConfiguracaoDeSeguranca {
    ...
    @Bean
    public SecurityFilterChain realizarFiltroInterno(HttpSecurity http) throws Exception {
        return http
    ...
    /**
     * O Bean vai gerenciar automaticamente quandoum tipo PasswordEncoder for
     * instanciado.
     */
    @Bean
